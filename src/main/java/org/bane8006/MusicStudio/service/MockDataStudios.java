...
public class MockDataStudios implements IDataStudiosService {
	...
	public Studio addStudioBean(Studio sb) {
		if (!getAllStudios().contains(sb)) {
			...
			return null;// System.out.println("Studio exists!");
	}
